...
const badges = [
  ...
  { emoji: "📢", label: "Publicité Ads" },
  { emoji: "⚡", label: "VibeCoding" },
];
    ...
    <section id="accueil" className="relative min-h-screen flex flex-col items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="relative mb-8">
          ...
          >
            <img src={photoSedgo} alt="SEDGO TK ALASSANE" className="w-full h-full object-cover" />
          </motion.div>
          ...
          {badges.map((badge, i) => (
            <motion.span
              ...
              className={`absolute bg-secondary text-secondary-foreground text-xs font-medium px-3 py-1.5 rounded-full border border-border animate-float ${
                i === 0 ? "-left-16 top-8" : i === 1 ? "-right-16 bottom-8" : "right-0 -top-2"
              }`}
        ...
        >
          Je suis <span className="text-gradient">SEDGO TK ALASSANE</span>,{" "}
          Architecte de Systèmes Digitaux <span className="text-gradient">Rentables</span>
        </motion.h1>
        ...
        >
          J'aide entrepreneurs et PME à créer des plateformes e-commerce, lancer des campagnes Facebook & TikTok rentables et automatiser leurs revenus grâce aux nouvelles technologies.
        </motion.p>
